...
With the premise being described by Bellman in 1957, we can conclude that many features does not only heavily impede model training but can additionally result in worse solutions. \cite{HandsOnMLCh8}
