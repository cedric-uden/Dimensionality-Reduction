...
To maximise the variance, we can then solve a constrained optimisation problem.
This will then diminish into an eigenvalue equation.
\bigskip


We will now go through the steps, one-by-one, to comprehend how to find an algebraic solution to this problem:
