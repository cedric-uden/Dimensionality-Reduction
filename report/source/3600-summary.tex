...
Contrary to the \acrshort{arpack} implementation in the previously discovered \gls{pca} package, this version does not centre the data  to deal with sparse matrices efficiently.
