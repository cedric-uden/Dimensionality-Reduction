...
Contrary to the ARPACK implementation in the previously discovered \gls{pca} package, this version does not center the data in order to deal with sparse matrices efficiently.
