\Acrlong{dr} is an important tool for data scientists to use when handling ever growing data sets that we encounter more and more frequently on a frequent basis.
\bigskip
