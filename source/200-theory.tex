...
The gross issues primarily consist of a finite amount of computational ressources available, especially back in the 1950's. 
...
This results in ourselves neither being able to rigorously understand the problem, nor to improve our predictions of challanges we are unable to analyse.
...
With the premise being described by Bellman in 1957, we can conclude that a large amount of features does not only heavily impede model training, but can additionaly result in worse solutions. \cite{HandsOnMLCh8}
